...
class MainApp(Ui_MainWindow):
    ...
    def update_device_status(self, data):
        ...
        mapping = {
            'a': lambda: self.IconDevice1.setPixmap(QtGui.QPixmap("icon/open.png")),
            'x': lambda: self.IconDevice1.setPixmap(QtGui.QPixmap("icon/close.png")),
            'b': lambda: self.IconDevice2.setPixmap(QtGui.QPixmap("icon/ON.png")),
            'y': lambda: self.IconDevice2.setPixmap(QtGui.QPixmap("icon/OFF.png")),
            'c': lambda: self.IconDevice3.setPixmap(QtGui.QPixmap("icon/fan on.png")),
            'z': lambda: self.IconDevice3.setPixmap(QtGui.QPixmap("icon/fan off.png")),
        }
